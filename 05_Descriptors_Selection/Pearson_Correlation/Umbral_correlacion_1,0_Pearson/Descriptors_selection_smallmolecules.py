...
#CORRELACION SPEARMAN Y ELIMINAR VARIABLES CON CORRELACION 1
...
#Guardar
predictores_y_respuesta_mol_peq_final.to_excel("datos_finales_molpeq_para_ML_1,0_pearson.xlsx", index=False)
