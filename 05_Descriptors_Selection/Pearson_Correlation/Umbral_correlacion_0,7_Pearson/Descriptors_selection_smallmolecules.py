...
#CORRELACION SPEARMAN Y ELIMINAR VARIABLES CON CORRELACION MAYOR A 0,7
...
#Guardar
predictores_y_respuesta_mol_peq_final.to_excel("datos_finales_molpeq_para_ML_0,7_pearson.xlsx", index=False)
