...
#CORRELACION PEARSON Y ELIMINAR VARIABLES CON CORRELACION MAYOR A 0,6
...
#Guardar
predictores_y_respuesta_mol_peq_final.to_excel("datos_finales_molpeq_para_ML_0,6_pearson.xlsx", index=False)
